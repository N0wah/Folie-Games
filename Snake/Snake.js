...
const changeFoodPosition = () => {     //fonction pour faire apparaitre la pomme aléatoirement

    foodX = Math.floor(Math.random()*15)+1; // position sur l'abscisse 
    foodY = Math.floor(Math.random()*15)+1; // position sur l'ordonné
